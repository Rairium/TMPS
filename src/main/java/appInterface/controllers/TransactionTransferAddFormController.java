...
public class TransactionTransferAddFormController implements Initializable {
    public TextField dateField;
    public TextField signatureField;
    public TextField amountField;
    public TextField typeField;
    public TextField clientIDNPField;
    ...
    public void insert(MouseEvent mouseEvent) throws SQLException {
        ...
        successAlert.setContentText("The Transfer Transaction was successfully created");
        successAlert.setHeaderText(null);

        Connection connection = DBConnect.getInstance().getConnection();
        Statement statement = connection.createStatement();
        statement.execute("INSERT into transferdocuments (td_date, td_signature, td_amount, td_type, td_client_IDNP , td_client) values " +
                "('" + dateField.getText() + "', '" + signatureField.getText() + "', '" + amountField.getText() + "', '" + typeField.getText() + "', '" + clientIDNPField.getText() + "', '" + getClientId() + "' )");
        successAlert.showAndWait();
        dateField.clear();
        signatureField.clear();
        amountField.clear();
        typeField.clear();
        clientIDNPField.clear();
    }
}
